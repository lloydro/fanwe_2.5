...
$distribution_cfg = array(
	...
	"RDB_CLIENT"	=>	"4b7c1d2cd1eb457e.m.cnhza.kvstore.aliyuncs.com", //必填,redis链接
	"RDB_PORT"	=>	"6379", //必填（redis使用的端口，默认为6379）
	"RDB_PASSWORD"	=>	"4b7c1d2cd1eb457e:Fanwe2017",  //必填 redis密码

	"SESSION_CLIENT"	=>	"4b7c1d2cd1eb457e.m.cnhza.kvstore.aliyuncs.com",  //必填,redis链接
	"SESSION_PORT"	=>	"6379", //必填（redis使用的端口，默认为6379）
	"SESSION_PASSWORD"	=>	"4b7c1d2cd1eb457e:Fanwe2017",   //必填 redis密码

    "CACHE_CLIENT"	=>	"4b7c1d2cd1eb457e.m.cnhza.kvstore.aliyuncs.com", //必填,redis链接
    "CACHE_PORT"	=>	"6379", //必填（redis使用的端口，默认为6379）
    "CACHE_PASSWORD"	=>	"4b7c1d2cd1eb457e:Fanwe2017",  //必填 redis密码
	...
	"AES_EXTRA_FUN" =>array(
		'app#init','login#do_login','user#usersig','login#wx_login','login#qq_login','login#sina_login','login#visitors_login','login#send_mobile_verify','login#do_update','app#aliyun_sts','login#is_user_verify', 'settings@mobile_binding'
	),
);
//关于分布式配置
