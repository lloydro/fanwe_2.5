...
class TipoffAction extends CommonAction{
    ...
    public function edit() {
        ...
        $vo['from_user_name'] = emoji_decode(M("User")->where("id = ".$vo['from_user_id'])->getField("nick_name"));
        $vo['to_user_name'] = emoji_decode(M("User")->where("id = ".$vo['to_user_id'])->getField("nick_name"));
        $this->assign ( 'vo', $vo );
