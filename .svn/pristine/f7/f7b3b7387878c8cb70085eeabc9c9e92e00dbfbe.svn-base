...
class BmPromoterPropAction extends CommonAction
{
    public function index()
    {
       ...
       $sql = "SELECT  l.id,u.id as user_id,l.to_user_id,sum(l.total_ticket) as total_ticket,u.nick_name,u.bm_special,bp.name as name,bp.user_id as promoter_user_id,bp.pid as promoter_p_id FROM   "
